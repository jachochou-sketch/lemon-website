  ...
  return (
    <Card padding="none" className="group flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        {/* Quick specs */}
        <div className="mb-5 grid grid-cols-2 border-y border-slate-900/10 py-3 text-[11px] text-slate-500">
          <span className="inline-flex items-center gap-1">
            <span className="font-medium text-slate-700">MOQ:</span> {product.minOrder}
          </span>
          <span className="inline-flex items-center gap-1">
            <span className="font-medium text-slate-700">Lead:</span> {product.deliveryTime}
          </span>
        </div>
