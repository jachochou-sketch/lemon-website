      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="relative">
          <select
            ...
            id={inputId}
            className={cn(
              'min-h-11 w-full border border-slate-900/20 bg-white px-4 py-2.5 text-slate-900',
              'focus:outline-none focus:ring-2 focus:ring-sky-700/15 focus:border-primary',
              'transition-[border-color,box-shadow] duration-200 appearance-none cursor-pointer',
